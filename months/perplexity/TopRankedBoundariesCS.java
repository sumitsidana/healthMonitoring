...
public class TopRankedBoundariesCS {
	/*
	...
	public static void main(String[] args) {
		...
		try{
			...
			for(int chldIndex = 0 ; chldIndex < chldHealthFilesRegions.length ; chldIndex++){
				...
				PrintWriter outBoundary1 = new PrintWriter
				...
				PrintWriter outBoundary3 = new PrintWriter
						(new BufferedWriter(new FileWriter
								(args[2]+"/"+chldHealthFilesRegions
										[chldIndex]+"/after"+dt3,true)));
				...
				BufferedReader brRegionalHealth = new BufferedReader
						(new InputStreamReader(inRegionalHealth));
