...
public class ConvertInferencesIntoWeeklyDistributions {
	/*
	...
	public static void main(String[] args) throws IOException {
		...
		while((strLine = br.readLine())!=null){
			...
			String uId = "0" ;
			if(dt.getWeekOfWeekyear()>=10)
				uId = dt.getYearOfCentury()+"_"+dt.getWeekOfWeekyear();
			else
				uId = dt.getYearOfCentury()+"_0"+dt.getWeekOfWeekyear();
